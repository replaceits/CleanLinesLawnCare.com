...
MISC_FILES = humans.txt robots.txt sitemap.xml message.php estimate.php android-chrome-192x192.png android-chrome-512x512.png apple-touch-icon.png browserconfig.xml favicon-16x16.png favicon-32x32.png favicon.ico manifest.json mstile-70x70.png mstile-150x150.png safari-pinned-tab.svg review.php
