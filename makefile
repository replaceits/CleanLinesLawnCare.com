...
DIRECTORIES     = $(BUILD_PATH) $(JS_TARGET_PATH) $(CSS_TARGET_PATH) $(ERRORS_TARGET_PATH) $(IMAGES_TARGET_PATH) $(FILES_TARGET_PATH)

all: | $(DIRECTORIES) css js errors html misc images
