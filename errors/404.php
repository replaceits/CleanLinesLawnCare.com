...
<html lang="en" style="overflow: hidden;">
    <head>
		...
		<title>404 Not found - Clean Lines Lawn Care</title>
		...
		<main class="container-fluid text-center">
            <div class="row">
                ...
                <section>
                    <div class="row">
                        <div class="col-xs-12">
                            <h4>We're sorry but the page "<?php echo(htmlspecialchars(strip_tags($_SERVER['REQUEST_URI']))); ?>" couldn't be found on this server!</h4>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-xs-12">
